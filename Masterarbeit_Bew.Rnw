...
\pkg{Fragestellung:} Welche Modell ist für die Auswertung geeignet?
...
\pkg{Fragestellung:} Gegeben unterschiedliche Gewichtung der Risiken, wie lösen wir das Prämienberechnungsproblem? 
